...
const ShaderBackground = () => {
  ...
  useEffect(() => {
    ...
    const loadShader = (context: WebGLRenderingContext, type: number, source: string): WebGLShader | null => {
    ...
    const initShaderProgram = (
      ...
      if (!context.getProgramParameter(shaderProgram, context.LINK_STATUS)) {
        console.error("Shader program link error: ", context.getProgramInfoLog(shaderProgram));
